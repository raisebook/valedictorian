...
describe('<Textarea>', () => {
  ...
  describe("initial state", () => {
    ...
    let subject = () => {
      return shallow(<Textarea {...props}></Textarea>);
    };
  ...
  describe("Lifecycle", () => {
    describe("Nested in a form", () => {
      beforeEach(() => {
        enzymeWrapper = mount(<Textarea />, { context: context });
      ...
      it("calls validate after mount", () => {
        let validate = sinon.stub(Textarea.prototype, 'validate');
        enzymeWrapper = mount(<Textarea />, { context: context });
  ...
  describe("update", () => {
    ...
    describe("with context", () => {
      ...
      beforeEach(() => {
        ...
        el = mount(<Textarea />, { context: context });
        component = el.instance();
      });
  ...
  describe("rendering", () => {
    it("renders an Textarea element", () => {
      enzymeWrapper = shallow(<Textarea></Textarea>);
      component = enzymeWrapper.instance();
      expect(enzymeWrapper.find("textarea")).to.have.length(1);
    });

    it("passes props", () => {
      enzymeWrapper = shallow(<Textarea type="text"></Textarea>);
      component = enzymeWrapper.instance();
      expect(enzymeWrapper.find("textarea").props().type).to.eq("text");
    });

    it("removes the validators prop", () => {
      enzymeWrapper = shallow(<Textarea type="text" validators={[]}></Textarea>);
      component = enzymeWrapper.instance();
    ...
    it("rebinds onChange with the update method", () => {
      ...
      enzymeWrapper = shallow(<Textarea type="text" validators={[]}></Textarea>);
      component = enzymeWrapper.instance();
      expect(enzymeWrapper.find("textarea").props().onChange).to.equal(mock);
      update.restore();
    });
  });
});
